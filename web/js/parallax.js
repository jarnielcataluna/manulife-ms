function mr_parallax() {
    ...
    function b() {
        var a, b = 0;
        return j() ? (b = jQuery("header").find(".header-content").outerHeight(!0), a = jQuery("header").find(".header-content").css("position"), ("absolute" === a || "fixed" === a) && (b = 0)) : b = jQuery(document).find("nav:first").outerHeight(!0), b
    }
    ...
    function h(a) {
        a.preventDefault && a.preventDefault(), v = a.notRealWheel ? -a.deltaY / 4 : 1 == a.deltaMode ? -a.deltaY / 3 : 100 === Math.abs(a.deltaY) ? -a.deltaY / 120 : -a.deltaY / 40, v = -y > v ? -y : v, v = v > y ? y : v, s = !0, u = z
    }
    ...
    jQuery(document).ready(function() {
        ...
        k = [], r = b();
        var a = j(),
            c = ".parallax .background-image-holder";
        a && (c = ".parallax .background-image-holder"), jQuery(c).each(function(b) {
